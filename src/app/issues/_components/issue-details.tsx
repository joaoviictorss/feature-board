...
import { CreateCommentSchema, IssueCommentForm } from "./issue-comment-form";
import { IssueCommentsList } from "./issue-coments-list";
...
export async function IssueDetails({ issueId }: IssueDetailsProps) {
  ...
  async function handleCreateComment(data: CreateCommentSchema) {
    ...
    await createComment({ issueId, text: data.text });
  }
